...
(function () {
  ...
  function addSwipeEvent(t, funcL, funcR) {
    ...
    function touchStart(event) {
      ...
      console.log(123);
      start_x = event.targetTouches[0].pageX; //alert(start_x);
    }
    ...
    function touchMove(event) {
      ...
      end_x = event.targetTouches[0].pageX; //alert(end_x - start_x);
    }
  ...
  function maxlengthInpout(el, num) {
    el.on('keyup', function () {
      ...
      var limit = num; //get the current text inside the textarea  

      var text = $(this).val(); //count the number of characters in the text  

      var chars = text.length;
      console.log(chars); //check if there are more characters then allowed  
  ...
  function initViewPort() {
    ...
    if (bIsAndroid) {
      ...
      var getTargetDensitydpi = VIEWPORT_WIDTH / deviceWidth * window.devicePixelRatio * 160;
      var targetDensitydpi = "target-densitydpi=".concat(getTargetDensitydpi, ", width=").concat(VIEWPORT_WIDTH, ", user-scalable=no");
      viewport.setAttribute('content', targetDensitydpi);
    } else {
      viewport.setAttribute('content', "width=".concat(VIEWPORT_WIDTH, " user-scalable=0"));
    }
  }

  ChungTool.initViewPort = initViewPort;
  ...
  ChungTool.pageScrollAni = pageScrollAni; //shareToLine

  ChungTool.shareToLine = shareToLine; //a tag

  ChungTool.getAtagElement = getAtagElement; // 轉成數字

  ChungTool["int"] = _int; // 重跑css animation

  ChungTool.replayCssAni = replayCssAni; // 取得背景圖案

  ChungTool.getDivBgImage = getDivBgImage; // 加 youtube 到 el 裡

  ChungTool.addYouTube = addYouTube; // 限制input的最大輸入數

  ChungTool.maxlengthInpout = maxlengthInpout; // 計算中英文的長度 (中文2英文1)

  ChungTool.txtByteLength = txtByteLength; // 移除特定開頭的class

  ChungTool.removeClassWithFilter = removeClassWithFilter; // 回傳以prefix開頭的class拿掉以prefix開頭後的文字 
...
var _default = ChungTool;
exports["default"] = _default;

},{}],4:[function(require,module,exports){
"use strict";

var _swiperBundleMin = _interopRequireDefault(require("../../node_modules/swiper/swiper-bundle.min.js"));

var _jquery = _interopRequireDefault(require("jquery"));

var _ChungTool = _interopRequireDefault(require("./libs/ChungTool"));
...
function initLang() {
  (0, _jquery["default"])(".zh-btn").on('click', function (e) {
    (0, _jquery["default"])('.mainContainer').removeClass('en');
    swiper.slideNext();
  });
  (0, _jquery["default"])(".en-btn").on('click', function (e) {
    (0, _jquery["default"])('.mainContainer').addClass('en');
    swiper.slideNext();
  });
}

function initSwiper() {
  swiper = new _swiperBundleMin["default"]('.swiper', {
    ...
    on: {
      ...
      slideChangeTransitionEnd: function slideChangeTransitionEnd() {
        ...
        var page = (0, _jquery["default"])(swiper.slides[swiper.activeIndex]);
        gsap.set('.aniel', {
          autoAlpha: 0
        });
...
},{"../../node_modules/swiper/swiper-bundle.min.js":2,"./libs/ChungTool":3,"jquery":1}]},{},[4]);
